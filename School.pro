...
UBUNTU_TRANSLATION_DOMAIN="school.mymike"
...
aptest.commands = bash $$PWD/School/tests/autopilot/run
aptest.depends  = sub-School

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/School/tests/unit 
unittest.depends  = sub-School
