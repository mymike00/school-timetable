        ...
        Page {
            ...
            header: PageHeader {
                ...
                extension: Flickable {
                    ...
                    clip: true
                    height: header_sections.height
                    contentWidth: header_sections.width
                ...
                onWidthChanged: {
                    resizing = true
                    if (width > header_sections.width/7*6) {
                    ...
                    header_sections.model = width > header_sections.width/7*6 ? header_sections.modelExtended : header_sections.model
                    resizing = false
